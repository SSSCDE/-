...
screen say(who, what):
    ...
    window:
        id "window"
        # 半透明深色背景 + 圆角
        background Frame("#1a1e24cc", 30, 30)
        ...
        if who is not None:
            window:
                id "namebox"
                background Frame("#ffffff", 10, 10)   # 人名背景色
                xalign 0.05
                yalign -0.3                             # 负值让它浮在上方
                xsize 260
                ysize 60
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        frame:
            # 背景样式
            background Frame("#1a1e2466", 10, 10)
            xalign 0.5
            yalign 0.01
            padding (20, 12)
...
screen main_menu():
    ...
    on "show" action Play("music", "bgm_title.mp3")

    # 背景图
    add "main_menu.jpg"

    # 标题图
    add "title.png" xalign 0.01 yalign 0 zoom 1.5
    ...
    frame:
        ...
        vbox:
            spacing 15
            textbutton "开始游戏" action [Play("sound", "correct_answer3.mp3"), Start()]
            textbutton "读取存档" action [Play("sound", "correct_answer3.mp3"), ShowMenu("load")]
            textbutton "游戏设置" action [Play("sound", "correct_answer3.mp3"), ShowMenu("preferences")]
            textbutton "关于" action [Play("sound", "correct_answer3.mp3"), ShowMenu("about")]
            textbutton "退出游戏" action [Play("sound", "correct_answer3.mp3"), Quit(confirm=True)]
    # 底部信息
    vbox:
        xalign 0.98
        yalign 0.98
        text "Made by SSSCDE" size 16 color "#ffffff"
        text "v[config.version]" size 14 color "#ffffff"
...
screen about():
    ...
    use game_menu(_("关于"), scroll="viewport"):
        ...
        vbox:
            ...
            text "西交內个物语" size 50 bold True color "#000000"
            text ""
            text "v[config.version]" size 30 color "#999999"
            text ""
            text "制作：SSSCDE" size 30 color "#999999"
            text ""
            text "一个发生在西安某大学的神秘故事。" size 30 color "#999999"
            text "內王争霸赛究竟是什么？" size 30 color "#999999"
            text "真相等待你的探索。" size 30 color "#999999"
            text ""
            text "感谢游玩！" size 30 color "#cccccc"
...
screen favor_hud():
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                spacing 10
                text "內內度" size 18 color "#000000" bold True yalign 0.5
                bar value nn range 10:
                    xsize 150
                    ysize 16
                    left_bar "#5078a0"
                    right_bar "#333333"
                text "[nn]" size 18 color "#000000" yalign 0.5
